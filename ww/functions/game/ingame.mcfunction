...
# Spectator Effects
effect give @a[tag=!alive] night_vision infinite 0 true
...
execute unless score %debugging system matches 1 unless entity @a[predicate=!ww:god,scores={dead=1..}] unless entity @a[scores={thiefTarget=1..}] run function ww:ending/main

function ww:game/detect_kill_all