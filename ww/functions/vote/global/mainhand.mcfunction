...
execute if predicate ww:mainhand/vote/assassin_wolf run function ww:vote/assassin_wolf
execute if predicate ww:mainhand/vote/assassin_choose run function ww:vote/assassin_wolf
