...
execute if entity @e[type=marker,tag=selectedMap,tag=map12] run function ww:setting/map/12/choose
execute if entity @e[type=marker,tag=selectedMap,tag=map13] run function ww:setting/map/13/choose
