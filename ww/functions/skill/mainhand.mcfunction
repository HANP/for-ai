...
execute if predicate ww:mainhand/powder run function ww:player/looking_at/casting
execute if predicate ww:mainhand/wooden_sword run function ww:player/looking_at/casting
execute if predicate ww:mainhand/steal run function ww:player/looking_at/casting
execute if predicate ww:mainhand/uv_light run function ww:player/looking_at/casting
execute if predicate ww:mainhand/implant_bomb run function ww:player/looking_at/casting

execute if predicate ww:mainhand/diary/team run function ww:skill/diary/team

execute if predicate ww:mainhand/hentai/arousal run function ww:skill/hentai/arousal
execute if predicate ww:mainhand/hentai/list run function ww:skill/hentai/list

execute if predicate ww:mainhand/blood_moon run function ww:role/wolf/bloody/blood_moon
