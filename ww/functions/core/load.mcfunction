...
execute if score %koumi_map system matches 1 run data modify storage ww:game mapNames set value ["雪町","美術館","水晶風暴","河堤社區","經典城鎮","海底都市","渡假村","Underground","威尼斯小鎮","花村","酷米溫泉旅館","卡歐魯の村莊","卡歐魯の混亂豪宅","卡歐魯の都市"]
...
tellraw @a [{"text":"[酷米家族] 狼人殺 - 重製版","color":"green","bold":true},{"text":" v10.1 ","color":"gold","bold":true},{"text":"已順利載入","color":"white","bold":false}]