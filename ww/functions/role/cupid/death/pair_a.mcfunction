...
# return pair_a book to cupid if other pair does not exist yet
execute unless entity @a[tag=currentTarget] as @p[tag=currentCupid,tag=!linked,tag=alive] run function ww:role/cupid/refund/pair_a
