...
tellraw @s [{"storage":"ww:game","nbt":"DISPLAY.info","interpret":true},{"text":"成功竊取 ","color":"white","bold":false},{"text":"獵人","color":"yellow","bold":false}]
...
tag @p[tag=thiefTarget] remove hunter
