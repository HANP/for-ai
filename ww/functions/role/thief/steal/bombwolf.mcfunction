...
tellraw @s [{"storage":"ww:game","nbt":"DISPLAY.info","interpret":true},{"text":"成功竊取 ","color":"white","bold":false},{"text":"炸彈狼","color":"yellow","bold":false}]

tag @p[tag=thiefTarget] remove bomb
