...
execute if score %spirit pool matches 1.. run tellraw @a [{"text":"灵媒: ","color":"white","bold":true},{"score":{"name":"%spirit","objective":"pool"},"color":"gold","bold":true}]
...
execute if score %detective pool matches 1.. run tellraw @a [{"text":"偵探: ","color":"white","bold":true},{"score":{"name":"%detective","objective":"pool"},"color":"gold","bold":true}]

execute if score %hentai pool matches 1.. run tellraw @a [{"text":"色狼: ","color":"light_purple","bold":true},{"score":{"name":"%hentai","objective":"pool"},"color":"gold","bold":true}]

execute if score %thief pool matches 1.. run tellraw @a [{"text":"盜賊: ","color":"white","bold":true},{"score":{"name":"%thief","objective":"pool"},"color":"gold","bold":true}]
