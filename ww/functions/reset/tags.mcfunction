...
tag @s remove wraith
tag @s remove voodoo
tag @s remove bewitcher

# campaign names
tag @s remove goods
tag @s remove bads
tag @s remove lovers
tag @s remove wraiths

tag @s remove officer
tag @s remove fool
tag @s remove inherited

# tag @s remove god

tag @s remove immortal
tag @s remove alive
tag @s remove sirenTarget
tag @s remove has_role
tag @s remove perm_invis
tag @s remove bewitched
tag @s remove harassed
tag @s remove bloodySacrifice
tag @s remove qualifiedBloodMoon

tag @s remove thiefTarget

function ww:reset/tags/context
function ww:reset/tags/debate
function ww:reset/tags/riot