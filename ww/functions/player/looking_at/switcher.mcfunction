...
execute as @e[type=#ww:targets,tag=this,limit=1] unless predicate ww:mainhand/rifle if predicate ww:offhand/rifle run function ww:role/hunter/rifle/hit
...
execute as @e[type=#ww:targets,tag=this,limit=1] if predicate ww:mainhand/powder run function ww:role/detective/powder/hit
execute as @e[type=#ww:targets,tag=this,limit=1] unless predicate ww:mainhand/powder if predicate ww:offhand/powder run function ww:role/detective/powder/hit

execute as @e[type=#ww:targets,tag=this,limit=1] if predicate ww:mainhand/wooden_sword run function ww:vote/morning/looking_at
execute as @e[type=#ww:targets,tag=this,limit=1] unless predicate ww:mainhand/wooden_sword if predicate ww:offhand/wooden_sword run function ww:vote/morning/looking_at

execute as @e[type=#ww:targets,tag=this,limit=1] if predicate ww:mainhand/steal run function ww:role/thief/steal
execute as @e[type=#ww:targets,tag=this,limit=1] unless predicate ww:mainhand/steal if predicate ww:offhand/steal run function ww:role/thief/steal

execute as @e[type=#ww:targets,tag=this,limit=1] if predicate ww:mainhand/uv_light run function ww:role/detective/uv_light
execute as @e[type=#ww:targets,tag=this,limit=1] unless predicate ww:mainhand/uv_light if predicate ww:offhand/uv_light run function ww:role/detective/uv_light

execute as @e[type=#ww:targets,tag=this,limit=1] if predicate ww:mainhand/implant_bomb run function ww:role/wolf/bomb/implant_bomb
execute as @e[type=#ww:targets,tag=this,limit=1] unless predicate ww:mainhand/implant_bomb if predicate ww:offhand/implant_bomb run function ww:role/wolf/bomb/implant_bomb