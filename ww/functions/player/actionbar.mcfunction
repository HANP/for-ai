...
data modify storage ww:game actionbar.bomb_timer set value '{"text":""}'
data modify storage ww:game actionbar.skillCD set value '{"text":""}'
...
execute if score @s bombTimer matches 1.. run function ww:player/actionbar/bomb_timer
execute if score @s skillCD matches 1.. run function ww:player/actionbar/skill_cd
...
data modify storage ww:game actionbar.combined set value '[{"text":"[","color":"white"},{"storage":"ww:game","nbt":"actionbar.inherited","interpret":true},{"storage":"ww:game","nbt":"role.fool","interpret":true,"color":"red","bold":true},{"storage":"ww:game","nbt":"role.name","interpret":true,"color":"blue","bold":true},{"storage":"ww:game","nbt":"actionbar.team","interpret":true},{"storage":"ww:game","nbt":"actionbar.visibility","interpret":true},{"text":"]","color":"white"},"  ",{"storage":"ww:game","nbt":"actionbar.bads","interpret":true},{"storage":"ww:game","nbt":"actionbar.goods","interpret":true},{"storage":"ww:game","nbt":"actionbar.wraiths","interpret":true},{"storage":"ww:game","nbt":"actionbar.item_name_combined","interpret":true},"  ",{"storage":"ww:game","nbt":"actionbar.lovers","interpret":true},{"storage":"ww:game","nbt":"actionbar.immune","interpret":true},{"storage":"ww:game","nbt":"actionbar.attraction","interpret":true},{"storage":"ww:game","nbt":"actionbar.digger","interpret":true},{"storage":"ww:game","nbt":"actionbar.bomb_timer","interpret":true},{"storage":"ww:game","nbt":"actionbar.skillCD","interpret":true}]'
